<template>
  <header class="bg-black relative z-1000 bg-radial-t-gray-to-black" id="header">
    ...
    <div class="logo pt-0 pb-16 md:pb-32 md:pt-16 container mx-auto text-center text-white">
      ...
      <font-awesome :icon="['fas', 'home']" class="text-gray-400 mt-3 mb-1 mr-3"></font-awesome>
      <font-awesome :icon="['fas', 'bus']" class="text-gray-400 mt-3 mb-1 mr-3"></font-awesome>
      <font-awesome :icon="['fas', 'plug']" class="text-gray-400 mt-3 mb-1 mr-3"></font-awesome>
    </div>
  </header>
</template>
